...
- **Minh chứng Screenshot:**
  ![API-BUG-01 Screenshot](API-BUG-01.png)
...
- **Minh chứng Screenshot:**
  ![API-BUG-02 Screenshot](API-BUG-02.png)
...
- **Mức độ nghiêm trọng:** High.
- **Minh chứng Screenshot:**
  ![API-BUG-03 Screenshot](API-BUG-03.png)
...
- **Mức độ nghiêm trọng:** High.
- **Minh chứng Screenshot:**
  ![API-BUG-04 Screenshot](API-BUG-04.png)
...
- **Minh chứng Screenshot:**
  ![API-BUG-05 Screenshot](API-BUG-05.png)
...
- **Minh chứng Screenshot:**
  ![API-BUG-06 Screenshot](API-BUG-06.png)
...
- **Mức độ nghiêm trọng:** High.
- **Minh chứng Screenshot:**
  ![API-BUG-07 Screenshot](API-BUG-07.png)
...
- **Minh chứng Screenshot:**
  ![API-BUG-08 Screenshot](API-BUG-08.png)
...
- **Mức độ nghiêm trọng:** Medium.
- **Minh chứng Screenshot:**
  ![API-BUG-09 Screenshot](API-BUG-09.png)
