...
*(Ghi chú: Yêu cầu chức năng FR-06 không quy định giới hạn trên (Upper Boundary) cho số lượng, do đó các giá trị liên quan đến UB được đánh dấu N/A.)*
...
| BVA_FR06_04 | BVA | Dưới UI Minimum (Số âm) | `Product ID` = Tồn tại<br>`Số lượng` = -1 | Do thẻ UI input không có ràng buộc, người dùng nhập -1. Hệ thống phải bắt lỗi và từ chối không cho phép thêm vào giỏ hàng. |
