...
| BUG-B-002 | B/B1,B1-b,B2 | Usability | Màu đỏ cho trạng thái "Saved" gây nhầm lẫn nghiêm trọng (Lỗi xác nhận từ User Testing) | G-05 / Nielsen #2 | 4 | Đổi sang màu primary hoặc accent (xanh) | `../02_Task1B_Checklist_Execution/Failed_Screenshots/fail_g05_save_red_1785689566491.png` | *(chưa gửi)* |
| BUG-B-003 | B/B1,B1-b | Bug | Search keyword bị mất khi quay lại từ trang chi tiết (Xác nhận khó chịu qua UT) | N-09 / Shneiderman #8 | 3 | Lưu search state vào URL query params hoặc sessionStorage | `../02_Task1B_Checklist_Execution/Failed_Screenshots/fail_n09_search_after_1785690326219.png` | *(chưa gửi)* |
...
| BUG-B-009 | B/B1,B1-b,B2 | Usability | Nhãn Save/Saved/Unsave/Save event không nhất quán (Xác nhận từ UT) | G-02 / Shneiderman #1 | 2 | Thống nhất dùng "Save"/"Saved" trên mọi trang | `../02_Task1B_Checklist_Execution/Failed_Screenshots/fail_g02_save_event_1785690214527.png` | *(chưa gửi)* |
...
| BUG-B-011 | B/B2 | Usability | Registration form không đánh dấu bắt buộc (Xác nhận từ UT) | F-02 / Nielsen #5 | 2 | Thêm dấu * hoặc text "Bắt buộc chọn ≥ 1 vai trò" | `../02_Task1B_Checklist_Execution/Failed_Screenshots/fail_f02_s11_registration_1785690112316.png` | *(chưa gửi)* |
| BUG-B-012 | B/B2 | Usability | Registration roles thiếu chú giải màu (Xác nhận từ UT) | S-11 / Nielsen #6 | 2 | Thêm legend giải nghĩa 4 màu trạng thái | `../02_Task1B_Checklist_Execution/Failed_Screenshots/fail_f02_s11_registration_1785690112316.png` | *(chưa gửi)* |
...
| BUG-B-014 | B/B1,B1-b | Usability | Menu chỉ có tiếng Anh, gây khó cho người dùng Việt (Phát hiện từ UT) | Nielsen #2 | 3 | Thêm i18n cho menu | *(Giao diện chung)* | *(chưa gửi)* |
| BUG-B-015 | B/B1 | Usability | Icon bookmark nhỏ, khó phát hiện cho người mới (Phát hiện từ UT) | Nielsen #6 | 1 | Thêm tooltip hoặc text "Lưu" | *(Quan sát thực tế)* | *(chưa gửi)* |
| BUG-B-016 | B/B1 | Usability | Live search không có nút Submit gây bối rối (Phát hiện từ UT) | Nielsen #2 | 0 | Thêm placeholder hướng dẫn cụ thể | *(Quan sát thực tế)* | *(chưa gửi)* |

**Tổng: 16 phát hiện đã được gộp (7 Bug + 9 Usability)**
