...
- Name: product-crud.spec.ts >> FR-15: Product Management (CRUD) - Admin Panel >> TC_FR15_09: Delete product: valid product — success
...
Locator: locator('table tbody tr').filter({ hasText: 'Bàn phím cơ Keychron Q1' }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('table tbody tr').filter({ hasText: 'Bàn phím cơ Keychron Q1' }).first()
