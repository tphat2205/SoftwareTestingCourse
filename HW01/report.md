...
| **Tool: ChatGPT Time: 12:02 AM 01/06/2026 Prompt: Chuột Gaming bluetooth không dây Atas F30 \- 3 Mode  \- Pin sạc 500mah  \- Sử dụng liên tục 50h  F30: 3 mode kết nối ( Có dây , bluetooth , không dây ) , DPI 10000, có app Macro , Polling Rate 1000hz THÔNG SỐ KỸ THUẬT chuột Gaming F30 \- Kết nối: Có dây , Bluetooth , không dây 2.4GhZ  \- Pin lithium 500mah.  \- Mắt Đọc: M16  \- Có app Marco  \- DPI: Max 10000 DPI  \- Polling Rate : 1000Hz  \- Con Lăn TTC cho độ bền cao.  \- Switches: Huyu Độ bền 20 triệu lượt nhấn\!  \- Chuyển chế độ kết nối với 1 nút bấm Bluetooth and Wireless 2.4GHz modes.  \- Thiết kế siêu nhẹ.  \- Màu sắc: Đen / Trắng  \- Low-resistance Teflon Feet. Based on this description of the mouse, Design 15 test cases (Objective / Input / Steps / Expected / Actual / Verdict). ** | Below are **15 test cases** for the **Atas F30 Bluetooth Wireless Gaming Mouse**.<br><br>&#124; TC ID &#124; Objective &#124; Input &#124; Steps &#124; Expected Result &#124; Actual Result &#124; Verdict &#124;<br>&#124; ----- &#124; ------------------------------------------------------------ &#124; ------------------------------ &#124; -------------------------------------------------------------------------------------------------------------------------------- &#124; ------------------------------------------------------------------------------------------------------ &#124; -------------- &#124; ------- &#124;<br>&#124; TC01 &#124; Verify wired connection mode &#124; USB cable, PC/laptop &#124; 1. Connect mouse to PC using USB cable. 2. Move mouse. 3. Left-click/right-click. &#124; Mouse works normally in wired mode. Cursor moves and buttons respond. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC02 &#124; Verify Bluetooth connection mode &#124; Bluetooth-enabled laptop/PC &#124; 1. Turn mouse on. 2. Switch to Bluetooth mode. 3. Pair with laptop/PC. 4. Move and click mouse. &#124; Mouse connects via Bluetooth and works normally. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC03 &#124; Verify 2.4GHz wireless connection mode &#124; USB receiver/dongle, PC/laptop &#124; 1. Plug 2.4GHz receiver into PC. 2. Switch mouse to wireless mode. 3. Move and click mouse. &#124; Mouse connects through 2.4GHz mode and works normally. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC04 &#124; Verify mode switching button &#124; Mouse mode switch button &#124; 1. Connect mouse in Bluetooth mode. 2. Press mode switch button. 3. Change to 2.4GHz mode. 4. Change to wired mode if supported. &#124; Mouse can switch between connection modes correctly. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC05 &#124; Verify maximum DPI setting &#124; DPI button / macro app &#124; 1. Open mouse app or press DPI button. 2. Set DPI to maximum 10000. 3. Move mouse on screen. &#124; Mouse supports DPI up to 10000 and cursor sensitivity increases clearly. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC06 &#124; Verify different DPI levels &#124; DPI button &#124; 1. Press DPI button several times. 2. Move mouse after each press. 3. Observe cursor speed. &#124; Cursor speed changes according to DPI level. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC07 &#124; Verify polling rate 1000Hz &#124; Polling rate test software &#124; 1. Connect mouse in wired or 2.4GHz mode. 2. Open polling rate checker. 3. Move mouse continuously. &#124; Polling rate can reach around 1000Hz. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC08 &#124; Verify battery charging &#124; USB charging cable &#124; 1. Connect mouse to charger/PC using USB cable. 2. Observe charging indicator. 3. Wait until fully charged. &#124; Mouse charges normally and indicator shows charging/full status. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC09 &#124; Verify battery usage time &#124; Fully charged mouse &#124; 1. Fully charge mouse. 2. Use continuously in wireless/Bluetooth mode. 3. Record total usage time. &#124; Mouse can operate close to the advertised 50 hours depending on usage conditions. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC10 &#124; Verify macro app detection &#124; Mouse macro software &#124; 1. Install/open macro app. 2. Connect mouse. 3. Check whether device is detected. &#124; App detects the F30 mouse successfully. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC11 &#124; Verify macro button configuration &#124; Macro app, mouse buttons &#124; 1. Open macro app. 2. Assign a macro to a button. 3. Save settings. 4. Press assigned button. &#124; Assigned macro runs correctly when button is pressed. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC12 &#124; Verify left and right button durability/basic response &#124; Left click, right click &#124; 1. Click left button multiple times. 2. Click right button multiple times. 3. Check response on PC. &#124; Both buttons respond accurately without double-click or missed-click issues. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC13 &#124; Verify scroll wheel function &#124; Scroll wheel &#124; 1. Open a long webpage/document. 2. Scroll up and down. 3. Press middle click. &#124; Scroll wheel moves smoothly and middle click works. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC14 &#124; Edge case: Verify connection recovery after PC sleep/restart &#124; PC sleep/restart &#124; 1. Connect mouse wirelessly. 2. Put PC to sleep or restart it. 3. Wake/reopen PC. 4. Move mouse. &#124; Mouse reconnects automatically or reconnects quickly without pairing again. &#124; Not tested yet &#124; TBD &#124;<br>&#124; TC15 &#124; Edge case: Verify low-battery behavior &#124; Mouse with low battery &#124; 1. Use mouse until battery is low. 2. Observe performance. 3. Try clicking and moving. 4. Connect charger if needed. &#124; Mouse should warn low battery if supported and should not randomly disconnect before battery is empty. &#124; Not tested yet &#124; TBD &#124;<br><br>**Note:** For your report, after testing the real mouse, replace **“Not tested yet”** with your real observation and replace **“TBD”** with **Pass** or **Fail**. | INCOMPLETE | *ISTQB FL §4.2.4 (Experience-based testing \- Exploratory & Error Guessing):* The AI failed to identify critical non-deterministic physical edge cases such as surface compatibility (glass/glossy surfaces) and electrical/mechanical status changes (operation behavior while actively charging, or receiver behavior when connected to loose ports). | Appended 3 highly specific engineering edge cases (EC01, EC02, EC03) focusing on mechanical, surface tracking, and charging-while-operating exceptions. Executed the tests on the real hardware. |
